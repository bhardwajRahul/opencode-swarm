...
## [7.185.0](https://github.com/bhardwajRahul/opencode-swarm/compare/v7.184.9...v7.185.0) (2026-09-19)
...
* **background:** autonomous PR babysitting settling loop ([#2502](https://github.com/bhardwajRahul/opencode-swarm/issues/2502)) ([bd0ad84](https://github.com/bhardwajRahul/opencode-swarm/commit/bd0ad8436c22c8d1589c7c7a8896568ea73f7030))
* **ci:** enforce required check contract ([4bb9f8a](https://github.com/bhardwajRahul/opencode-swarm/commit/4bb9f8ac3451fd4f7aee189203fbb7ec8bd0d1cd))
* **ci:** enforce required check contract ([3be4102](https://github.com/bhardwajRahul/opencode-swarm/commit/3be41022eae2ffc8cdcce0c60bff6187513cc400))
...
* **sdd:** Spec-Kit v2 multi-feature projection with feature-scoped ids + opt-in tasks.md check-off ([#2501](https://github.com/bhardwajRahul/opencode-swarm/issues/2501)) ([146719b](https://github.com/bhardwajRahul/opencode-swarm/commit/146719b2d7299e56800c458ffd06c5dcdf1a0ac7))
...
* **atomic-write:** re-point WRITER_CLASSIFICATION producer citations after [#2532](https://github.com/bhardwajRahul/opencode-swarm/issues/2532) line shifts ([d7d9a13](https://github.com/bhardwajRahul/opencode-swarm/commit/d7d9a13df9e8979a79c0d711c22100117a4f3328))
...
* **background:** Copilot review fixes — durable refusal terminals, state schema, fail-closed head eval ([#2502](https://github.com/bhardwajRahul/opencode-swarm/issues/2502)) ([1f10168](https://github.com/bhardwajRahul/opencode-swarm/commit/1f10168ac6d3634660f8106c82210dcb6bba085a))
...
* **background:** reviewer round-1 fixes for the PR feedback loop ([#2502](https://github.com/bhardwajRahul/opencode-swarm/issues/2502)) ([8c20bb0](https://github.com/bhardwajRahul/opencode-swarm/commit/8c20bb05e233015752fe1bcd4ccde1ea76078a8f))
...
* **ci:** fetch full history for merge-group coverage ([ae8d1e3](https://github.com/bhardwajRahul/opencode-swarm/commit/ae8d1e30e6a2c9a8f3b926d9162aa43fdafd53f4))
...
* **ci:** harden required check contract enforcement ([9483e59](https://github.com/bhardwajRahul/opencode-swarm/commit/9483e59a01a924c9b644450f58f0bfc03b36a9ea))
...
* **ci:** satisfy workflow security gate ([ef3606d](https://github.com/bhardwajRahul/opencode-swarm/commit/ef3606d9158d6b57b3d39081457f974a24d40bca))
...
* harden PR workflow gate lifecycle cleanup ([e578665](https://github.com/bhardwajRahul/opencode-swarm/commit/e578665522b73bf89a530c0db223ef6b6200b074))
...
* **memory:** harden cohort migration locking per review ([34d57bb](https://github.com/bhardwajRahul/opencode-swarm/commit/34d57bb3e6f680a00509c14e9bbaa8c24a86bc20))
...
* **memory:** serialize cohort destination migration under its live lock ([90f7f2e](https://github.com/bhardwajRahul/opencode-swarm/commit/90f7f2e2fe704f83db89a1ecff070e7fd66faeba))
* **memory:** serialize cohort destination migration under its live lock ([593596a](https://github.com/bhardwajRahul/opencode-swarm/commit/593596ab544c204653b8b2b2a70da5ec0f22592a))
* **mutation,go,test:** clock-lint fixture, trailing-newline hunks, go cleaned-source scan, skill clarification (2492 review round 2) ([1c2289c](https://github.com/bhardwajRahul/opencode-swarm/commit/1c2289c77a66579d8c600dd1bbd7b7c0a0e0b2d1))
* **mutation:** refuse derive-mode cap overflow on the analyzer budgetExceeded signal ([#2492](https://github.com/bhardwajRahul/opencode-swarm/issues/2492) final-critic round 1) ([21a8620](https://github.com/bhardwajRahul/opencode-swarm/commit/21a862032a13946ca36e15e8cb38172139eaca07))
...
* **observability:** refresh producer line offsets ([6aad485](https://github.com/bhardwajRahul/opencode-swarm/commit/6aad4858f9781303d2187d5a2d07937ffc2f2097))
...
* **plan-schema:** tolerate task-less in-memory phases in the phase resolver; hermetic WIRE-045 ([4dd5b39](https://github.com/bhardwajRahul/opencode-swarm/commit/4dd5b397d9f28698c61e530bebd65ca8dd2fdd77))
* **plan:** keep docs receipts verifiable across the live cursor advance ([#2532](https://github.com/bhardwajRahul/opencode-swarm/issues/2532) review) ([7f94dc5](https://github.com/bhardwajRahul/opencode-swarm/commit/7f94dc5ba403cea868f2392c16ab326a795cb5b4))
* **plan:** lazy-import scope-persistence at the Rule-2 site ([cbf6449](https://github.com/bhardwajRahul/opencode-swarm/commit/cbf6449ca6c5158712c7113df900d9574d30ed94))
* **plan:** parallel-first scheduling and phase progression use current bindings ([#2532](https://github.com/bhardwajRahul/opencode-swarm/issues/2532)) ([7a62535](https://github.com/bhardwajRahul/opencode-swarm/commit/7a62535d3d9a6d49c5a4460ed63114ff74889464))
* **plan:** parallel-first scheduling and phase progression use current bindings ([#2532](https://github.com/bhardwajRahul/opencode-swarm/issues/2532)) ([47a0b18](https://github.com/bhardwajRahul/opencode-swarm/commit/47a0b1854aad9f448bf7fac24e42c5d435119a26))
...
* **pr-workflow:** terminalize orphaned lifecycle state ([8742965](https://github.com/bhardwajRahul/opencode-swarm/commit/8742965fe9554b661e1d26a44899d948b485acad))
* **pr-workflow:** terminalize orphaned lifecycle state ([11efc55](https://github.com/bhardwajRahul/opencode-swarm/commit/11efc5530a76677dc355ab4b281cd130151485d7))
...
* **repo-map:** connect the six remaining audit actions + VALID_ACTIONS consumer ratchet ([#2540](https://github.com/bhardwajRahul/opencode-swarm/issues/2540)) ([a424a7d](https://github.com/bhardwajRahul/opencode-swarm/commit/a424a7dfc0097ec8baecd8a1cfde27a5874da18d))
* **repo-map:** connect the six remaining audit actions and add VALID_ACTIONS consumer ratchet ([#2540](https://github.com/bhardwajRahul/opencode-swarm/issues/2540)) ([fad8fe3](https://github.com/bhardwajRahul/opencode-swarm/commit/fad8fe3c9c41f7b38938fd9a9352fe1aa950f504))
...
* **session:** key the directory memo by the lexical alias identity ([dfecd10](https://github.com/bhardwajRahul/opencode-swarm/commit/dfecd10839f978a86a891168ce0990db525c9ab7))
...
* **state:** close PR [#2742](https://github.com/bhardwajRahul/opencode-swarm/issues/2742) review findings — populate guard, registry hygiene, docs accuracy ([d20fa95](https://github.com/bhardwajRahul/opencode-swarm/commit/d20fa9553dcea6f536aed5aebf5658004afd393f))
...
* **state:** make live state and hydration project-owned and generation-fenced ([d9fa703](https://github.com/bhardwajRahul/opencode-swarm/commit/d9fa703ad192e2a490b8d61a8a572cbf5d094059)), closes [#2667](https://github.com/bhardwajRahul/opencode-swarm/issues/2667)
...
* **test-impact:** bound parser and containment paths ([1c39251](https://github.com/bhardwajRahul/opencode-swarm/commit/1c39251434a074f724f93ad0bcc159f25082090d))
* **test-impact:** close bounded mutation feedback gaps ([b45b322](https://github.com/bhardwajRahul/opencode-swarm/commit/b45b322e1599130d34fc720a838ff974d77a1a45))
* **test-impact:** close PR feedback findings ([fa130f5](https://github.com/bhardwajRahul/opencode-swarm/commit/fa130f59b6cb2ed07f0366a9cfc92a2fcebfa9d0))
* **test-runner,mutation,analyzer:** address pr-review findings on 2492 (union-bounded budget, full-file diff reconstruction, skill/docs updates) ([3d4c371](https://github.com/bhardwajRahul/opencode-swarm/commit/3d4c371ef36f65e5b40c692e672495e5be4ad0e2))
* **test-runner,mutation:** bounded multi-source scope + analyzer-derived mutation selection ([#2492](https://github.com/bhardwajRahul/opencode-swarm/issues/2492)) ([961ad53](https://github.com/bhardwajRahul/opencode-swarm/commit/961ad53c61a7e6c6540507f8ef984d2991ed58c9))
* **test-runner,mutation:** bounded multi-source scope, analyzer-derived mutation selection, language-aware equivalence ([#2492](https://github.com/bhardwajRahul/opencode-swarm/issues/2492)) ([22e09f8](https://github.com/bhardwajRahul/opencode-swarm/commit/22e09f86be866ec8c9e607cd771e080660b2a7df))
* **test-runner:** preserve cap decision on impact overflow ([918aaec](https://github.com/bhardwajRahul/opencode-swarm/commit/918aaec2063423b36b88882f680d2665431432a3))
* **test:** address pr-review findings on 2540 (FR-011 tmpdir, helper extraction, payload probes, mirror wording) ([8d21797](https://github.com/bhardwajRahul/opencode-swarm/commit/8d21797c7afc6ca861059ed4d13d3e6bf61a5fee))
* **test:** correct canonicalMkdtemp import depth in 2492 suites ([4495ca1](https://github.com/bhardwajRahul/opencode-swarm/commit/4495ca1217f6ae96cb9bfb36d25b0c57b434deea))
...
* **tools:** bound impact and repo-map workflows ([dc03800](https://github.com/bhardwajRahul/opencode-swarm/commit/dc03800c58ed5e189490008e1d3d3a9b60e9eee5))
* **tools:** bound impact and repo-map workflows ([8b7d5a7](https://github.com/bhardwajRahul/opencode-swarm/commit/8b7d5a784e41223aacd2b115bb254f55f6f89aa2))
* **tools:** close PR feedback bounds and portability gaps ([8346e1e](https://github.com/bhardwajRahul/opencode-swarm/commit/8346e1e7ac7ab76515042ffcb891d4e54105254c))
